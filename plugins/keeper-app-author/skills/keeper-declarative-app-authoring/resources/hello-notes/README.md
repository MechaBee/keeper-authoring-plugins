...
assumptions. Contracts remain authoritative. First read the applicable contract
documents and the assigned brief. Use this example only when a new app needs an
...
`contracts/components/record-collection.md`: instant create with optional fields, an autosaving
...
defaults shown in `patterns/app-foundation.md`.
