...
For a complete starting point, inspect the descriptors and seed files below. For a focused change,
inspect the affected lifecycle and its dependencies. All records are fabricated.
