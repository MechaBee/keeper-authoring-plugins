...
This is a complete, data-free collaborative Kanban app with one `record_board` view. For a complete new-app starting point, inspect these six descriptors; for a focused change, inspect
the affected descriptors and their dependencies:
