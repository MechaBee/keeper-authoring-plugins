...
When using this as a complete new-app starting point, inspect the package:
...
Choose a smaller example when possible. Use [Hello notes](../hello-notes/README.md) for compact
capture, [Time Tracker](../time-tracker/README.md) for task-oriented entry/reporting UX, and
[Effective-dated rules](../effective-dated-rules/README.md) for successor versions and current snapshots.
