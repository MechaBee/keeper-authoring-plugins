...
A horizontal split is the general multi-column layout and may contain more than two children. It
stacks vertically on small screens and becomes proportional columns at the runtime's large-screen
breakpoint; `sizes` supplies the relative flex weights. A vertical split remains a full-width stack.
Nest stacks, splits, and tabs rather than inventing a `columns` layout kind.
